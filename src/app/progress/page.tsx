    ...
    <>
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        ...
        <Card className="no-print lg:col-span-1">
          ...
          {!currentMember ? (
            <p className="rounded-2xl bg-[var(--tone-amber-soft)] px-4 py-5 text-sm text-[var(--tone-amber-text)]">
            ...
            <>
                ...
                {page.map((log) => {
                  ...
                  return (
                    <li key={log.id} className="print-break relative">
                      <span className="absolute top-4 -left-[27px] size-3 rounded-full border-2 border-surface bg-line-2" />
                      ...
                      <div className="rounded-2xl border border-line p-4">
                        <div className="flex items-start justify-between gap-3">
                          ...
                          <button
                            ...
                            className="no-print grid size-7 shrink-0 place-items-center rounded-full text-faint transition hover:bg-[var(--tone-red-soft)] hover:text-[var(--tone-red-text)]"
                          >
                        ...
                        <div className="mt-3 flex flex-wrap items-center gap-2">
                          {task && (
                            <>
                              ...
                              <span className="text-xs text-faint">{projectName}</span>
                            </>
                          )}
              ...
              {visibleLogs.length > shown && (
                <button
                  ...
                  className="no-print mt-4 w-full rounded-2xl border border-line py-2.5 text-sm font-medium text-ink-2 transition hover:bg-surface-2"
                >
